...
model_state = torch.load(
    "./models/emotion_detection_model_state.pth", map_location=torch.device('cpu'))
...
def expression_classifier(image):
    ...
    return label, inference_time, conf.item()


if __name__ == "__main__":
    print(expression_classifier(cv2.imread("./image_sample/157.jpg")))
